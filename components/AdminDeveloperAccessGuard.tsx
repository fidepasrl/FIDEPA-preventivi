...
export default function AdminDeveloperAccessGuard({
  children,
  nomeSezione,
}: {
    ...
    return (
      <div className="flex min-h-[45vh] items-center justify-center">
        <div className="flex items-center gap-3 text-sm text-gray-500">
          <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-white text-[#5E9AD3] shadow-sm">
    ...
    return (
      <div className="rounded-2xl border border-white bg-white p-8 shadow-[0_8px_24px_rgba(15,23,42,0.06)]">
        <div className="flex items-start gap-4">
          <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#D79D06]/12 text-[#D79D06]">
            <AppIcon name="userAdmin" size={22} />
          </span>
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-gray-500">
              {nomeSezione} è disponibile solo per account ADMIN e DEVELOPER.
            </p>
          </div>
        </div>
      </div>
