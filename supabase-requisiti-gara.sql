...
create policy "gara_categorie_select" on public.gara_categorie for select using (true);
drop policy if exists "gara_categorie_insert" on public.gara_categorie;
create policy "gara_categorie_insert" on public.gara_categorie for insert with check (true);
drop policy if exists "gara_categorie_update" on public.gara_categorie;
create policy "gara_categorie_update" on public.gara_categorie for update using (true) with check (true);
drop policy if exists "gara_categorie_delete" on public.gara_categorie;
create policy "gara_categorie_delete" on public.gara_categorie for delete using (true);

alter table public.gara_lavori enable row level security;
drop policy if exists "gara_lavori_select" on public.gara_lavori;
create policy "gara_lavori_select" on public.gara_lavori for select using (true);
drop policy if exists "gara_lavori_insert" on public.gara_lavori;
create policy "gara_lavori_insert" on public.gara_lavori for insert with check (true);
drop policy if exists "gara_lavori_update" on public.gara_lavori;
create policy "gara_lavori_update" on public.gara_lavori for update using (true) with check (true);
drop policy if exists "gara_lavori_delete" on public.gara_lavori;
create policy "gara_lavori_delete" on public.gara_lavori for delete using (true);
...
create policy "gara_lavori_categorie_select" on public.gara_lavori_categorie for select using (true);
drop policy if exists "gara_lavori_categorie_insert" on public.gara_lavori_categorie;
create policy "gara_lavori_categorie_insert" on public.gara_lavori_categorie for insert with check (true);
drop policy if exists "gara_lavori_categorie_update" on public.gara_lavori_categorie;
create policy "gara_lavori_categorie_update" on public.gara_lavori_categorie for update using (true) with check (true);
drop policy if exists "gara_lavori_categorie_delete" on public.gara_lavori_categorie;
create policy "gara_lavori_categorie_delete" on public.gara_lavori_categorie for delete using (true);
...
create policy "gara_fatturati_select" on public.gara_fatturati for select using (true);
drop policy if exists "gara_fatturati_insert" on public.gara_fatturati;
create policy "gara_fatturati_insert" on public.gara_fatturati for insert with check (true);
drop policy if exists "gara_fatturati_update" on public.gara_fatturati;
create policy "gara_fatturati_update" on public.gara_fatturati for update using (true) with check (true);
drop policy if exists "gara_fatturati_delete" on public.gara_fatturati;
create policy "gara_fatturati_delete" on public.gara_fatturati for delete using (true);
...
create policy "gara_preparazioni_select" on public.gara_preparazioni for select using (true);
drop policy if exists "gara_preparazioni_insert" on public.gara_preparazioni;
create policy "gara_preparazioni_insert" on public.gara_preparazioni for insert with check (true);
drop policy if exists "gara_preparazioni_update" on public.gara_preparazioni;
create policy "gara_preparazioni_update" on public.gara_preparazioni for update using (true) with check (true);
drop policy if exists "gara_preparazioni_delete" on public.gara_preparazioni;
create policy "gara_preparazioni_delete" on public.gara_preparazioni for delete using (true);
...
create policy "gara_preparazione_requisiti_select" on public.gara_preparazione_requisiti for select using (true);
drop policy if exists "gara_preparazione_requisiti_insert" on public.gara_preparazione_requisiti;
create policy "gara_preparazione_requisiti_insert" on public.gara_preparazione_requisiti for insert with check (true);
drop policy if exists "gara_preparazione_requisiti_update" on public.gara_preparazione_requisiti;
create policy "gara_preparazione_requisiti_update" on public.gara_preparazione_requisiti for update using (true) with check (true);
drop policy if exists "gara_preparazione_requisiti_delete" on public.gara_preparazione_requisiti;
create policy "gara_preparazione_requisiti_delete" on public.gara_preparazione_requisiti for delete using (true);
...
create policy "gara_preparazione_partecipanti_select" on public.gara_preparazione_partecipanti for select using (true);
drop policy if exists "gara_preparazione_partecipanti_insert" on public.gara_preparazione_partecipanti;
create policy "gara_preparazione_partecipanti_insert" on public.gara_preparazione_partecipanti for insert with check (true);
drop policy if exists "gara_preparazione_partecipanti_update" on public.gara_preparazione_partecipanti;
create policy "gara_preparazione_partecipanti_update" on public.gara_preparazione_partecipanti for update using (true) with check (true);
drop policy if exists "gara_preparazione_partecipanti_delete" on public.gara_preparazione_partecipanti;
create policy "gara_preparazione_partecipanti_delete" on public.gara_preparazione_partecipanti for delete using (true);
...
create policy "gara_preparazione_partecipante_requisiti_select" on public.gara_preparazione_partecipante_requisiti for select using (true);
drop policy if exists "gara_preparazione_partecipante_requisiti_insert" on public.gara_preparazione_partecipante_requisiti;
create policy "gara_preparazione_partecipante_requisiti_insert" on public.gara_preparazione_partecipante_requisiti for insert with check (true);
drop policy if exists "gara_preparazione_partecipante_requisiti_update" on public.gara_preparazione_partecipante_requisiti;
create policy "gara_preparazione_partecipante_requisiti_update" on public.gara_preparazione_partecipante_requisiti for update using (true) with check (true);
drop policy if exists "gara_preparazione_partecipante_requisiti_delete" on public.gara_preparazione_partecipante_requisiti;
create policy "gara_preparazione_partecipante_requisiti_delete" on public.gara_preparazione_partecipante_requisiti for delete using (true);
...
create policy "professionisti_requisiti_gara_select" on public.professionisti_requisiti_gara for select using (true);
drop policy if exists "professionisti_requisiti_gara_insert" on public.professionisti_requisiti_gara;
create policy "professionisti_requisiti_gara_insert" on public.professionisti_requisiti_gara for insert with check (true);
drop policy if exists "professionisti_requisiti_gara_update" on public.professionisti_requisiti_gara;
create policy "professionisti_requisiti_gara_update" on public.professionisti_requisiti_gara for update using (true) with check (true);
drop policy if exists "professionisti_requisiti_gara_delete" on public.professionisti_requisiti_gara;
create policy "professionisti_requisiti_gara_delete" on public.professionisti_requisiti_gara for delete using (true);
